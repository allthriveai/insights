...
### Basic Image
![Alt text describing the image](images/example-image.png)
...
### Image with Title
![Detailed alt text for accessibility](images/example-with-title.png "This text appears on hover")

### Linked Images
[![Alt text for linked image](images/clickable-image.png)](https://destination-url.com)
